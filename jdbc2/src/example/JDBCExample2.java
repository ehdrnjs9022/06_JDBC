...
public class JDBCExample2 {
	public static void main(String[] args) {
		 ...
		 *	ex0 ?에 String 대입 -> CHAR 타입 리터럴 ('1234')
		 *												(양쪽에 ;; 자동 추가)
		 *
		 *	장점 3 : 
		 ...
		 *   
		 *   PreparedStatement는 
		 *   ?(placeholder)를 이용해서 파라미터(값=전달된값)만
		 *   연결 하기 때문에 SQL Injecttion을 방지할 수 있다!
		 *   
		 */
		
			try {
				// 커넥션 생성
				Class.forName("oracle.jdbc.OracleDriver"); // Drivermanager가 알아서 읽어가져감
				...
				/* DML(INSERT, UPDATE, DLETE) 시 AutoCommit 끄기! 
				...
				pstmt.setString(1, id); // 첫번쨰 물음표에 ''를 추가하여  'id'를 넣겠다 
				 ...
				 * 						- insert,update 둘다 execute update
				 * */
